...
import flowerImage from "../../assets/images/ourfeatures.jpg";

const Feature = () => {
    return (
        <div style={{ marginTop: '100px', fontFamily: 'Unna, serif', backgroundSize: 'cover', backgroundPosition: 'center' }}> 
            <header style={{ color: '#fff', padding: '20px', textAlign: 'center',  backgroundImage: `url(${flowerImage})`,fontSize: "90px" }}>
                <h1 style={{ fontSize: "50px"}}>Our Features</h1>
            </header>
            <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', padding: '20px' }}>
                <div style={{ textAlign: 'center' }}>
                    <FontAwesomeIcon icon={faLock} size="3x" style={{ color: '#ffb5b5 ', marginBottom: '10px' }} />
                ...
                <div style={{ textAlign: 'center' }}>
                    <FontAwesomeIcon icon={faStar} size="3x" style={{ color: '#ffb5b5', marginBottom: '10px' }} />
